...
class BibleChatAi:
    ...
    - Также если тебя просят процитировать какой то стих ты цитируешь его с объяснением
...
if __name__ == '__main__':
    input = "Процитируй мне Псалом 90:10"
    print(BibleChatAi.askBibleChat(input, [], ""))